...
*/
const int max_processes_fcfs = 1000;
const int fields_fcfs = 7;

void fcfs(array<array<int, fields_fcfs>, max_processes_fcfs> data, int num_processes) {

    array<array<int, fields_fcfs>, max_processes_fcfs> processes = data; // deep copy
